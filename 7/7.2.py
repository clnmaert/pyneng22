...
#попытался сам написать. Всё то писал, но коряво и через жопу и не работало. Например я делал рстрип еще до if и
# не работало. А когда внутри принта делаешь рстрип, то всё ок.